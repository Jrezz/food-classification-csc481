"""
Food Classification and Calorie Estimation — CSC 481
...
Usage:
    ...
    python main.py --all --subset 0.05 --epochs 2   # quick test
"""
...
def main():
    ...
    parser.add_argument("--data-root",   default="./food_data/food-101", help="Directory for Food-101 dataset")
    parser.add_argument("--results-dir", default="./results", help="Root directory for outputs")
    ...
    parser.add_argument("--pca",         type=int, default=200, help="PCA components for SVM/RF")
    parser.add_argument("--tolerance",   type=float, default=50.0, help="Calorie tolerance in kcal for Exp 4")
